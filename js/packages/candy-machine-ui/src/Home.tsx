...
const Home = (props: HomeProps) => {
  ...
  return (
    ...
    <div className='cover-bg' >
        ...
        <Grid className='logo-img' item md={5} sm={4} xs={12} >
        <img  width="150px" src='https://www.alpacaland.io/assets/images/Logo.png' alt='logo' />
      </Grid>
        ...
        <Grid item xs={12} sm={10} md={5} className='text-grid'>
      <Container  >
